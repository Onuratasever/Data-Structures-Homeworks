...
public class Account {
	...
	private LinkedList<String> WhosProfile;
	...
	private LinkedList<Message> messages_inbox;
	
	
	//private Message[] messages_outbox;
	//private ArrayList<Message> messages_outbox;
	LinkedList<Message> messages_outbox;
	...
	Account(String username, String birthdate, String location, String IdNum)
	{
		...
		messages_inbox = new LinkedList<Message>();
		
		//messages_outbox = new Message[0];
		//messages_outbox = new ArrayList<Message>();
		messages_outbox = new LinkedList<Message>();
		...
		WhosProfile = new LinkedList<String>();
