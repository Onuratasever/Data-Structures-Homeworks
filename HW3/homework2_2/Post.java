...
public class Post {
	...
	private LDLinkedList<Interaction> likes;
	
	//private Comment[] comments;
	//private ArrayList<Interaction> comments;
	private LDLinkedList<Interaction> comments;
	...
	Post(String content, String accountID, int postID)
	{
		...
		likes = new LDLinkedList<Interaction>();
		comments = new LDLinkedList<Interaction>();
	}
	 ...
	 */
	public void displayInteractions(LDLinkedList<Interaction> display)
	{
		int i;
